import { Group, Mesh, MeshLambertMaterial, CylinderGeometry, SphereGeometry, BoxGeometry } from '../three/three.module.js';

// Same C/r/G/P/o/t palette order as tools/sprites/gen_world.py and gen.py.
export const GARDEN_SHIRTS=['#3c78dc','#d03434','#469640','#9646b4','#e88228','#3caaa0']         ;
export const GARDEN_HATS=['straw','cap','top','bandana']         ;
...
export function gardenWardrobe(color       ,hat       ) {
...
export function gardenHat(style                           , tint        )       {
  ...
  const add=(geometry                                            ,y       )=>{const mesh=new Mesh(geometry,material);mesh.position.y=y;root.add(mesh);return mesh;};
